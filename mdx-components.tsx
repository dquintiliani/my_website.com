...
/**
 * This file is required by Next.js App Router's MDX convention.
 * It maps HTML elements to custom React components used inside MDX files.
 * You can also register any custom React components here to use them in MDX.
 *
